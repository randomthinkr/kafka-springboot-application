...
public class OrderController {
    ...
    public OrderController(OrderConsumerService orderConsumerService) {
    ...
    public ResponseEntity<List<Order>> getOrders() {
        ...
        return ResponseEntity.ok().body(orderConsumerService.getOrders());
    }

    @GetMapping("/{orderId}")
    public ResponseEntity<Order> getOrder(@PathVariable String orderId) {

        return ResponseEntity.ok().body(orderConsumerService.getOrder(orderId));
    }
