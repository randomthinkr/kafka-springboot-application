...
@Configuration
@Slf4j
public class KafkaShippingConsumerConfiguration {
    ...
    @Autowired
    private ShippingConsumerService consumerService;

    @Bean
    public ConsumerFactory<String, Order> shippingConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, "shipping-consumer");
    ...
    kafkaShippingListenerContainerFactory() {
